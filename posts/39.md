...
## [Bootstrapping a Type System][39]

   [39]: http://journal.stuffwithstuff.com/2010/10/29/bootstrapping-a-type-system/ (Bootstrapping a Type System)

[code][40] | [java][41] | [language][42] | [magpie][43] [2010][44] / [10][45]
/ [29][46]
   ...
   [45]: http://journal.stuffwithstuff.com/2010/10/ (month)
   [46]: http://journal.stuffwithstuff.com/2010/10/29/
...
(maybe [Typed Scheme][47]?), much less _true_, so I'll try to break that down.

   [47]: http://www.ccs.neu.edu/home/samth/typed-scheme/
...
a type, but it's not a class. Magpie also has [ad-hoc unions][48], so "int or
string" is a type, but it's not a class.

   [48]: http://journal.stuffwithstuff.com/2010/08/23/void-null-maybe-and-nothing/
...
Given generics, you should be able to instantiate them with any _type_, not
...
The parser converts that into an [AST][51], a little tree like:


       [51]: http://en.wikipedia.org/wiki/Abstract_syntax_tree
...
basically [one file][52].

   [52]: http://bitbucket.org/munificent/magpie/src/tip/src/com/stuffwithstuff/magpie/interpreter/ExprChecker.java
...
type, so [`Interface`][53] implements it, of course:


       [53]: http://bitbucket.org/munificent/magpie/src/8865c82a958d/base/Interface.mag
