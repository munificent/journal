...
## [The Language I Wish Go Was](http://journal.stuffwithstuff.com/2010/10/21/the-language-i-wish-go-was/ "The Language I Wish Go Was")


[code](http://journal.stuffwithstuff.com/category/code/ "View all posts in code") | [go](http://journal.stuffwithstuff.com/category/go/ "View all posts in go") | [language](http://journal.stuffwithstuff.com/category/language/ "View all posts in language") [2010](http://journal.stuffwithstuff.com/2010/ "year") / [10](http://journal.stuffwithstuff.com/2010/10/ "month") / [21](http://journal.stuffwithstuff.com/2010/10/21/)
...
Go already has multiple returns, so the utility of [tuples](http://en.wikipedia.org/wiki/Tuple)-- ad-hoc data
...
[Pike][52], [Typed Scheme][53], and the [Closure Javascript Compiler](http://code.google.com/closure/compiler/)
...
proofing](http://journal.stuffwithstuff.com/2010/09/18/futureproofing-uniform-access-and-masquerades/) and I think it's one of the biggest sources of the detested
