...
## [The Biology of Sloppy Code][39]

   [39]: http://journal.stuffwithstuff.com/2010/11/26/the-biology-of-sloppy-code/ (The Biology of Sloppy Code)

[code][40] [2010][41] / [11][42] / [26][43]

   [40]: http://journal.stuffwithstuff.com/category/code/ (View all posts in code)
   [41]: http://journal.stuffwithstuff.com/2010/ (year)
   [42]: http://journal.stuffwithstuff.com/2010/11/ (month)
   [43]: http://journal.stuffwithstuff.com/2010/11/26/

I'm watching the [Future of Programming Languages][44] panel and a point came
...
in programming", Guy Steele said, "Maybe it's sloppy programming."
   ...
   [44]: http://www.infoq.com/presentations/Future-of-Programming-Languages
...
sociology. (Or maybe in order of [decreasing hubris][45].) Each of these
...
complexity of chemistry and, using a bunch of [clever engineering][46], we
build a virtual world of data simpler than even basic physics.

   [46]: http://en.wikipedia.org/wiki/Analog-to-digital_converter
...
In the early 70s, people started talking about the [software crisis][48]: it
...
before you filled your head.
   ...
   [48]: http://en.wikipedia.org/wiki/Software_crisis
...
is true. Almost any coder knows the archetype of the "[real programmer][49]":
...
majors who partied through school.
   ...
   [49]: http://en.wikipedia.org/wiki/Real_Programmer
...
end of the spectrum. [DHH][51] may have never written a linked list in his
life, and he just bought a house in Italy for _[his car][52]_. If you spent
...
time and are now finding yourself becoming outdated, that can't feel good.
   ...
   [51]: http://en.wikipedia.org/wiki/David_Heinemeier_Hansson
   [52]: http://www.autoblog.com/2010/09/07/pagani-zonda-hh-commissioner-revealed-as-30-year-old-chicago-sof/
