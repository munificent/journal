...
## [Rethinking User-defined Operators][39]

   [39]: http://journal.stuffwithstuff.com/2010/12/31/rethinking-user-defined-operators/ (Rethinking User-defined Operators)

[code][40] | [cpp][41] | [go][42] | [java][43] | [language][44] | [magpie][45]
| [parsing][46] [2010][47] / [12][48] / [31][49]
   ...
   [42]: http://journal.stuffwithstuff.com/category/go/ (View all posts in go)
   [43]: http://journal.stuffwithstuff.com/category/java/ (View all posts in java)
   [44]: http://journal.stuffwithstuff.com/category/language/ (View all posts in language)
   [45]: http://journal.stuffwithstuff.com/category/magpie/ (View all posts in magpie)
   [46]: http://journal.stuffwithstuff.com/category/parsing/ (View all posts in parsing)
   [47]: http://journal.stuffwithstuff.com/2010/ (year)
   [48]: http://journal.stuffwithstuff.com/2010/12/ (month)
   [49]: http://journal.stuffwithstuff.com/2010/12/31/
...
stay clear of scary [operator jungle][50] apparently waiting just off the
beaten path.

   [50]: http://jim-mcbeath.blogspot.com/2008/12/scala-operator-cheat-sheet.html
...
Magpie's type system is [implemented in Magpie][51]. This means that operators
on types are just regular Magpie operators. One common operator is `|`. It
creates a [union type][52] out of two types. If you have a variable of type
`Int | String` then at runtime it can hold a value that's an Int or a String.

   [51]: http://journal.stuffwithstuff.com/2010/10/29/bootstrapping-a-type-system/
   [52]: http://en.wikipedia.org/wiki/Union_%28computer_science%29
...
[Effective Java][53].
   ...
   [53]: http://java.sun.com/docs/books/effective/
