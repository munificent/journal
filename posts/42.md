...
## [The Trouble with Constructors](http://journal.stuffwithstuff.com/2010/12/14/the-trouble-with-constructors/ "The Trouble with Constructors")


[code](http://journal.stuffwithstuff.com/category/code/ "View all posts in code") | [language](http://journal.stuffwithstuff.com/category/language/ "View all posts in language") | [magpie](http://journal.stuffwithstuff.com/category/magpie/ "View all posts in magpie") [2010](http://journal.stuffwithstuff.com/2010/ "year") / [12](http://journal.stuffwithstuff.com/2010/12/ "month") / [14](http://journal.stuffwithstuff.com/2010/12/14/)
...
Records in Magpie are as they are in ML: [structurally-typed](http://en.wikipedia.org/wiki/Structural_type_system) anonymous
...
[definite assignment](http://java.sun.com/docs/books/jls/first_edition/html/16.doc.html). Part of the type-checking process will be to walk
...
Whoops! That last one is a [doozy](http://lambda-the-ultimate.org/node/3186). I _hate_ having to check for `null` at
...
[surprisingly tricky](http://www.haskell.org/haskellwiki/Tying_the_Knot) to solve it.
